...
let MagicCircle=(function () {
    ...
    let FireShader={
        ...
        //////////////////////////////////////////////////////////////
            ...
            "{",
                ...
                //
                "float clip = 210.0;",
                "float ypartClip = vUv.y/clip*2000;",
                ...
                //
                "vec2 coordScaled = 0.01*vUv - 0.02*vec2(offset.x,0.0);",
                ...
                "vec2 sparkCoord = vUv - vec2(2.0*offset.x,190.0*realTime);",
    ...
    class Light1{
        ...
        initBasic(){
            let g=new THREE.CylinderBufferGeometry(this.radius,this.radius,this.height,50,1,true);
            ...
            let g2 = new THREE.CylinderBufferGeometry(this.radius*0.8,this.radius*0.8,0,50,1,false);
            ...
            //mesh2.position.set(0,this.height*1.2,0);
